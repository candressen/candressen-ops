...
export const AGENTS: {
  ...
  currentTask: string;
  schedule: string;
  team: 'dev' | 'marketing' | 'specialist' | 'council' | 'pol';
}[] = [
  { id: 'bob', name: 'Bob', role: 'Orchestrator', model: 'claude-sonnet-4-6', provider: 'Anthropic', status: 'online', emoji: '🔧', currentTask: 'Always on — orchestrating all projects', schedule: 'Always on', team: 'dev' },
  { id: 'woz', name: 'Woz', role: 'Coding', model: 'gpt-5.4', provider: 'OpenAI', status: 'idle', emoji: '🛠️', currentTask: 'Standing by', schedule: 'On-demand', team: 'dev' },
  { id: 'dan', name: 'Dan', role: 'Content', model: 'gpt-5.4', provider: 'OpenAI', status: 'idle', emoji: '✍️', currentTask: 'Standing by', schedule: 'On-demand', team: 'marketing' },
  { id: 'felix', name: 'Felix', role: 'Email Writing', model: 'gpt-4o', provider: 'OpenAI', status: 'idle', emoji: '📧', currentTask: 'Standing by', schedule: 'On-demand', team: 'marketing' },
  { id: 'hulk', name: 'Hulk', role: 'Lead Scraping', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '💪', currentTask: 'Standing by', schedule: 'On-demand', team: 'marketing' },
  { id: 'nora', name: 'Nora', role: 'Analytics', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '📊', currentTask: 'Standing by', schedule: 'On-demand', team: 'marketing' },
  { id: 'vero', name: 'Vero', role: 'Social Scheduling', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '📱', currentTask: 'Standing by', schedule: 'On-demand', team: 'marketing' },
  { id: 'cristina', name: 'Cristina', role: 'Voice Agent', model: 'gpt-realtime-2', provider: 'OpenAI', status: 'idle', emoji: '🎙️', currentTask: 'Standing by', schedule: 'On-demand', team: 'marketing' },
  { id: 'marcopolo', name: 'MarcoPolo', role: 'Code Locator', model: 'gpt-4o', provider: 'OpenAI', status: 'idle', emoji: '🗺️', currentTask: 'Standing by', schedule: 'On-demand', team: 'specialist' },
  { id: 'pablo', name: 'Pablo', role: 'Docs & Spec Writer', model: 'gpt-4o', provider: 'OpenAI', status: 'idle', emoji: '📱', currentTask: 'Standing by', schedule: 'On-demand', team: 'specialist' },
  { id: 'duy', name: 'Duy', role: 'Schema Guardian', model: 'gpt-4o', provider: 'OpenAI', status: 'idle', emoji: '🧪', currentTask: 'Standing by', schedule: 'On-demand', team: 'specialist' },
  { id: 'socrates', name: 'Socrates', role: 'Contrarian', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '🏛️', currentTask: 'Standing by', schedule: 'On-demand', team: 'council' },
  { id: 'descartes', name: 'Descartes', role: 'First Principles', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '🔭', currentTask: 'Standing by', schedule: 'On-demand', team: 'council' },
  { id: 'leibniz', name: 'Leibniz', role: 'Expansionist', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '🌐', currentTask: 'Standing by', schedule: 'On-demand', team: 'council' },
  { id: 'seneca', name: 'Seneca', role: 'Outsider', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '📜', currentTask: 'Standing by', schedule: 'On-demand', team: 'council' },
  { id: 'machiavelli', name: 'Machiavelli', role: 'Executor', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '♟️', currentTask: 'Standing by', schedule: 'On-demand', team: 'council' },
  { id: 'pol', name: 'Pol', role: 'Orchestrator', model: 'claude-sonnet-4-6', provider: 'Anthropic', status: 'idle', emoji: '🤖', currentTask: 'Standing by', schedule: 'On-demand', team: 'pol' },
  { id: 'jeff', name: 'Jeff', role: 'Coding', model: 'gpt-5.4', provider: 'OpenAI', status: 'idle', emoji: '💻', currentTask: 'Standing by', schedule: 'On-demand', team: 'pol' },
  { id: 'scrappy', name: 'Scrappy', role: 'Lead Scraping', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '🔍', currentTask: 'Standing by', schedule: 'On-demand', team: 'pol' },
  { id: 'indranil', name: 'Indranil', role: 'Email Writer', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '✉️', currentTask: 'Standing by', schedule: 'On-demand', team: 'pol' },
  { id: 'sunil', name: 'Sunil', role: 'Email Sender', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '📤', currentTask: 'Standing by', schedule: 'On-demand', team: 'pol' },
  { id: 'mahima', name: 'Mahima', role: 'Analytics', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '📊', currentTask: 'Standing by', schedule: 'On-demand', team: 'pol' },
  { id: 'ranjita', name: 'Ranjita', role: 'Enrichment', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '🔬', currentTask: 'Standing by', schedule: 'On-demand', team: 'pol' },
  { id: 'estella', name: 'Estella', role: 'Ad Creative', model: 'gpt-5.4', provider: 'OpenAI', status: 'idle', emoji: '🎨', currentTask: 'Standing by', schedule: 'On-demand', team: 'pol' },
  { id: 'cal', name: 'Cal', role: 'Scheduling', model: 'o4-mini', provider: 'OpenAI', status: 'idle', emoji: '📅', currentTask: 'Standing by', schedule: 'On-demand', team: 'pol' },
];
